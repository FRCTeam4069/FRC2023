...
public class R_Middle_OneAndHalf extends SequentialCommandGroup {
    public PathPlannerTrajectory path0 = PathPlanner.loadPath("M_Right",
            new PathConstraints(5, 4));

    public R_Middle_OneAndHalf() {
        addCommands(
                new placeCubeL3());
