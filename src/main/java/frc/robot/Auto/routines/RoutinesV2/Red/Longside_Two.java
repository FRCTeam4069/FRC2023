...
public class Longside_Two extends SequentialCommandGroup {
    public PathPlannerTrajectory path0 = PathPlanner.loadPath("R_Bump_s0",
            new PathConstraints(5, 4));
    public PathPlannerTrajectory path1 = PathPlanner.loadPath("R_Bump_s1",
            new PathConstraints(5, 4));
